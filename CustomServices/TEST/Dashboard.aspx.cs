...
public partial class Dashboard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (objMenu.GetAccessMenu(Session["user_login_name"].ToString(), "ToNa").Tables[0].Rows.Count == 0)
                Response.Redirect("AdminControlPanel.aspx");

        }
        else
            Response.Redirect("login.aspx?ReturnUrl=Dashboard.aspx?CompanyID=" + Request["CompanyID"]);
