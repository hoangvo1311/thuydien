<%@ Page Language="C#" MasterPageFile="~/Admin/AdminVTT.master" AutoEventWireup="true"
    CodeFile="ManagePolls.aspx.cs" Inherits="Admin_ManagePolls" Title=""
    ValidateRequest="false" %>

<%@ Register Src="Modules/Polls/PollUpdate.ascx" TagName="PollUpdate" TagPrefix="uc3" %>
<%@ Register Src="Modules/Polls/PollAddnew.ascx" TagName="PollAddnew" TagPrefix="uc2" %>
<%@ Register Src="Modules/Polls/PollOptionsList.ascx" TagName="PollOptionsList" TagPrefix="uc1" %>
<%@ Register Src="Modules/Polls/PollsList.ascx" TagName="PollsList" TagPrefix="uc4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-primary">
        ...
        <div id="content-area">
            ...
            <uc4:PollsList ID="PollsList1" runat="server" OnDetailsClick="ViewDetails_Click" />
            <uc1:PollOptionsList ID="PollOptionsList1" runat="server" />
        </div>
        <uc2:PollAddnew ID="PollAddnew1" runat="server" />
        <uc3:PollUpdate ID="PollUpdate1" runat="server" />
