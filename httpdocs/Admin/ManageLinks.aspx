<%@ Page Language="C#" MasterPageFile="~/Admin/AdminVTT.master" AutoEventWireup="true"
    CodeFile="ManageLinks.aspx.cs" Inherits="Admin_ManageLinks" Title="" %>

<%@ Register Src="Modules/Links/LinksList.ascx" TagName="LinksList" TagPrefix="uc1" %>
<%@ Register Src="Modules/Links/LinkAddnew.ascx" TagName="LinkAddnew" TagPrefix="uc2" %>
<%@ Register Src="Modules/Links/LinkUpdate.ascx" TagName="LinkUpdate" TagPrefix="uc3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <hr class="admin-hr" />
            <uc2:LinkAddnew ID="LinkAddnew1" runat="server" />
            <uc3:LinkUpdate ID="LinkUpdate1" runat="server" />
            <uc1:LinksList ID="LinksList1" runat="server" OnDetailsClick="ViewDetails_Click" />
