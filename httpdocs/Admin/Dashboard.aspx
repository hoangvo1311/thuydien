               ...
               <div class="row">
                  ...
                  <div class="col-lg-6 col-6">
                     <div class="small-box bg-danger">
                        <div class="inner">
                           <div class="measurementName">Nhà máy</div>
						   <span>
						   <div class="measurementValue" style="margin-bottom: 33px;">
						   <asp:DropDownList CssClass="form-control" ID="cmbPlants" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbPlants_SelectedIndexChanged" OnTextChanged="cmbPlants_TextChanged">
                           </asp:DropDownList>
						   </div>
                  ...
                  <div class="col-lg-6 col-6">
                     ...
                     <div class="small-box bg-danger">
                        <div class="inner">
                           <div class="measurementName">Lưu lượng dự báo</div>
                           <div class="measurementValue">
                              <asp:Label Text='<%#measurement != null ? measurement.Qve_HoDB  : "" %>' runat="server" />
                              m<sup>3</sup>/s
                           </div>
                        </div>
                        <div class="icon">
