<%@ Page Language="C#" MasterPageFile="~/Admin/AdminVTT.master" AutoEventWireup="true"
    CodeFile="ManageOldMembers.aspx.cs" Inherits="Admin_ManageOldMembers" Title="" %>

<%@ Register Src="Modules/OldMembers/OldMemberList.ascx" TagName="OldMemberList"
    TagPrefix="uc1" %>
<%@ Register Src="Modules/OldMembers/OldMemberView.ascx" TagName="OldMemberView"
    TagPrefix="uc2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="module-content">
        ...
        <div id="content-area">
            <hr class="admin-hr" />
            <uc2:OldMemberView ID="OldMemberView1" runat="server" />
            <uc1:OldMemberList ID="OldMemberList1" runat="server" OnDetailsClick="ViewDetails_Click" />
        </div>
    </div>
    <!-- #div:module-content -->
