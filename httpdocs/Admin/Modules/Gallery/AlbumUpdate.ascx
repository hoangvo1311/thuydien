<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AlbumUpdate.ascx.cs" Inherits="Admin_Modules_Gallery_AlbumUpdate" %>
<table cellpadding="5" class="table table-condensed">
    <tr>
