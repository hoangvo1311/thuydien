<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FAQAddNew.ascx.cs" Inherits="Admin_Modules_FAQ_FAQAddNew" %>
    ...
    <tr>
        ...
        <td style="height: 26px">
            <asp:TextBox ID="txtQuestion" runat="server" MaxLength="256" ValidationGroup="FAQ"
                 CssClass="form-control"></asp:TextBox><asp:RequiredFieldValidator ID="rqQuestion" runat="server" ControlToValidate="txtQuestion"
                Display="None" ErrorMessage="Bạn chưa nhập tên liên kết" SetFocusOnError="True"
                ValidationGroup="FAQ"></asp:RequiredFieldValidator></td>
    </tr>
