...
public partial class Admin_Modules_Video_VideoList : System.Web.UI.UserControl
{
    public ArrayList SelectedIDs
    {
        get
        {
            ...
            for (int i = 0; i < grdVideo.Rows.Count; i++)
            {
                bool isSelected = ((CheckBox)grdVideo.Rows[i].FindControl("chk")).Checked;
                if (isSelected)
                    _SelectedIds.Add(grdVideo.DataKeys[i].Value);
            }
    ...
    public override void DataBind()
    {
        ...
        this.grdVideo.DataSource = obj.LoadAll();
        this.grdVideo.DataBind();
    }
    ...
    protected void grdVideo_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "viewDetails")
        {
            ...
            this.SelectedID = byte.Parse(this.grdVideo.DataKeys[index].Value.ToString());
