...
namespace IndusG.DataAccess
{
    ...
    public partial class DB_Sesan
    {
        ...
        public Nullable<bool> IsPushedToBitexco { get; set; }
        public Nullable<bool> IsSync { get; set; }
        public string Minutes { get; set; }
        public Nullable<double> Qve_TT { get; set; }
        public Nullable<double> Qve_TB { get; set; }
        public Nullable<bool> IsPushedToSoTNMT { get; set; }
        public Nullable<bool> IsPushedToCucTNMT { get; set; }
    }
}
