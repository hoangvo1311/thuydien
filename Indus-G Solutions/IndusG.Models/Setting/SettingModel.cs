...
namespace IndusG.Models
{
    public class SettingModel
    {
        ...
        // TODO: UPDATE BASED ON PLANT
        [DisplayName("Dung tích hữu ích (m3)")]
        public double DungTichHuuIch { get; set; }

        //[DisplayName("Dung tích hữu ích 1 (m3)")]
        //public Nullable<double> DungTichHuuIch1 { get; set; }

        //[DisplayName("Dung tích hữu ích 2 (m3)")]
        //public Nullable<double> DungTichHuuIch2 { get; set; }


        [DisplayName("Trữ lượng nước trong hồ")]
        public double Reserve_Water { get; set; }

        [DisplayName("Lượng mưa")]
        ...
        // TODO: CHANGE NAME BASED ON PLANT
        [DisplayName("Độ mở cảm biến")]
        ...
        [DisplayName("Dung tích 1 (m3)")]
        public Nullable<double> DungTich1 { get; set; }
        [DisplayName("Dung tích 2 (m3)")]
        public Nullable<double> DungTich2 { get; set; }
        [DisplayName("Dung tích 3 (m3)")]
        public Nullable<double> DungTich3 { get; set; }
        [DisplayName("Dung tích 4 (m3)")]
        public Nullable<double> DungTich4 { get; set; }
    }
}